...
int main(int argc, char** argv) {
    ...
    out << "#pragma once\n";
    out << "\n";
    out << "// AUTO-GENERATED by tools/seed-pinner/pin_seeds.cc. DO NOT EDIT BY HAND.\n";
    out << "//\n";
    ...
    out << "// std::uniform_int_distribution differently, so the same Rng seed will\n";
    out << "// produce different sequences. R12 (pin determinism across STL) carries\n";
    out << "// the cross-platform divergence risk; STL-divergent action flip is a\n";
    ...
    out << "//   build/Debug/sts2_seed_pinner > engine/cpp/tests/seeds/expected_values.h\n";
    out << "\n";
    out << "#include <array>\n";
    out << "#include <cstdint>\n";
    out << "\n";
