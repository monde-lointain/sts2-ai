...
public static class Program
{
    ...
    private static object CombatStateBody(StateBlob blob)
    {
        ...
        return new Dictionary<string, object?>(StringComparer.Ordinal)
        {
            ...
            ["attacks_played_this_turn"] = state.Trail.AttacksPlayedThisTurn,
            ["cards_drawn_this_combat"] = state.Trail.CardsDrawnThisCombat,
            ["last_spent_energy"] = state.Trail.LastSpentEnergy,
            ["exhausted_shiv_count"] = state.Trail.ExhaustedShivCount,
