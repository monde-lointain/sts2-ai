...
int main(int argc, char** argv) {
    ...
    if (!sts2::app::parse_args(argc, argv, seed, seed_provided, std::cerr)) return 1;
        ...
        switch (a.kind) {
            ...
            case sts2::input::Action::PlayCard: {
                ...
                if (target_type == sts2::game::TargetType::AnyEnemy) {
                    ...
                    if (target < 0) {
                        std::cout << sts2::ansi::kRed << "  no valid target." << sts2::ansi::kReset << "\n";
                        break;
                    }
                }
            ...
            case sts2::input::Action::Invalid:
                std::cout << sts2::ansi::kRed << "  invalid input." << sts2::ansi::kReset << "\n";
                break;
        }
    }
}
