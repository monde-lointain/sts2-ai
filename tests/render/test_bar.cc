...
using sts2::glyphs::kEmptyBlock;
using sts2::glyphs::kFullBlock;
...
TEST(RenderHpBar, T_RND_055_WidthOneVisibilityFloor) {
    EXPECT_EQ(sts2::render::hp_bar(5, 10, 1), std::string(kFullBlock));
}
