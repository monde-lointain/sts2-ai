...
public static class StateCodecFixtures
{
    ...
    private static byte[] CanonicalContentHash =>
        ManifestStamp.ContentHashFromIds(new[]
        {
    ...
    private static ManifestStamp StampEmptyStrings() =>
        new("", "", CanonicalContentHash);
    ...
    private static Creature BuildPlayer(int hp, int maxHp, int block,
        params PowerInstance[] powers)
        => new(0, "Silent", hp, maxHp, block,
            powers.Length == 0
                ? ImmutableList<PowerInstance>.Empty
                : ImmutableList.CreateRange(powers),
            null, IsPlayer: true);

    private static Creature BuildEnemy(uint id, string name, int hp, int maxHp, int block,
        MonsterIntent? intent,
        params PowerInstance[] powers)
        => new(id, name, hp, maxHp, block,
            powers.Length == 0
                ? ImmutableList<PowerInstance>.Empty
                : ImmutableList.CreateRange(powers),
            intent, IsPlayer: false);

    private static CardInstance Card(uint id, string modelId, int upgrade = 0, int? costOverride = null)
    ...
    public static List<StateCodecFixture> GenerateAll()
    {
        ...
        result.Add(new StateCodecFixture(
            ...
            new CombatState(
                ...
                Energy: 3, BaseEnergyPerTurn: 3, HandDrawSize: 5,
                DrawPile: CardPile.Empty, HandPile: CardPile.Empty,
                DiscardPile: CardPile.Empty, ExhaustPile: CardPile.Empty,
                PlayerRngCounter: 0, MonsterRngCounter: 0),
            RunRng("seed-42"), PlayerRng(42u), Tokens(), Stamp()));
        ...
        result.Add(new StateCodecFixture(
            ...
            new CombatState(
                ...
                Energy: 3, BaseEnergyPerTurn: 3, HandDrawSize: 5,
                DrawPile: Pile(
                    Card(10, "StrikeSilent"), Card(11, "StrikeSilent"),
                    Card(12, "DefendSilent"), Card(13, "Neutralize"),
                    Card(14, "Survivor")),
                HandPile: Pile(
                    Card(20, "StrikeSilent"), Card(21, "StrikeSilent"),
                    Card(22, "DefendSilent"), Card(23, "DefendSilent"),
                    Card(24, "Survivor")),
                DiscardPile: CardPile.Empty, ExhaustPile: CardPile.Empty,
                PlayerRngCounter: 5, MonsterRngCounter: 2),
        ...
        result.Add(new StateCodecFixture(
            ...
            new CombatState(
                ...
                Energy: 2, BaseEnergyPerTurn: 3, HandDrawSize: 5,
                ...
                PlayerRngCounter: 8, MonsterRngCounter: 3),
            RunRng("seed-42", shuffleCount: 1),
            PlayerRng(42u), Tokens(), Stamp()));
        ...
        result.Add(new StateCodecFixture(
            ...
            new CombatState(
                ...
                HandPile: Pile(
                    Card(20, "StrikeSilent"), Card(21, "DefendSilent"),
                    Card(22, "Neutralize"), Card(23, "Survivor"),
                    Card(24, "Survivor")),
                DiscardPile: Pile(Card(10, "StrikeSilent"), Card(12, "DefendSilent"),
                    Card(13, "Neutralize"), Card(14, "Survivor")),
                ExhaustPile: CardPile.Empty,
                PlayerRngCounter: 12, MonsterRngCounter: 5),
        ...
        result.Add(new StateCodecFixture(
            ...
            new CombatState(
                ...
                DiscardPile: Pile(Card(10, "StrikeSilent"), Card(11, "DefendSilent"),
                    Card(12, "Neutralize"), Card(13, "Survivor"),
                    Card(14, "StrikeSilent"), Card(15, "DefendSilent"),
                    Card(16, "Neutralize"), Card(17, "Survivor")),
                ExhaustPile: CardPile.Empty,
                PlayerRngCounter: 20, MonsterRngCounter: 7),
            RunRng("seed-42", shuffleCount: 3),
            PlayerRng(42u, rewardsCount: 1), Tokens(), Stamp()));
        ...
        result.Add(new StateCodecFixture(
            ...
            new CombatState(
                ...
                Player: BuildPlayer(70, 70, 0),
                Enemies: ImmutableList.Create(
                    BuildEnemy(1, "CalcifiedCultist", 20, 50, 0, Attack(6),
                        new PowerInstance("PoisonPower", 99, 0u, false))),
                Energy: 3, BaseEnergyPerTurn: 3, HandDrawSize: 5,
                DrawPile: CardPile.Empty, HandPile: CardPile.Empty,
                DiscardPile: CardPile.Empty, ExhaustPile: CardPile.Empty,
                PlayerRngCounter: 30, MonsterRngCounter: 10),
            RunRng("seed-42"), PlayerRng(42u), Tokens(), Stamp()));
        ...
        result.Add(new StateCodecFixture(
            ...
            new CombatState(
                ...
                Energy: 0, BaseEnergyPerTurn: 3, HandDrawSize: 5,
                DrawPile: CardPile.Empty, HandPile: CardPile.Empty,
                DiscardPile: CardPile.Empty, ExhaustPile: CardPile.Empty,
                PlayerRngCounter: 0, MonsterRngCounter: 0),
            RunRng("seed-42"), PlayerRng(42u), Tokens(), Stamp()));
        ...
        result.Add(new StateCodecFixture(
            ...
            new CombatState(
                ...
                Enemies: ImmutableList.Create(
                    BuildEnemy(1, "CalcifiedCultist", 50, 50, 0, Attack(6))),
                Energy: 3, BaseEnergyPerTurn: 3, HandDrawSize: 10,
                DrawPile: CardPile.Empty,
                HandPile: Pile(
                    Card(20, "StrikeSilent"), Card(21, "StrikeSilent"),
                    Card(22, "StrikeSilent"), Card(23, "DefendSilent"),
                    Card(24, "DefendSilent"), Card(25, "Neutralize"),
                    Card(26, "Survivor"), Card(27, "Survivor"),
                    Card(28, "Acrobatics"), Card(29, "Backflip")),
                DiscardPile: CardPile.Empty, ExhaustPile: CardPile.Empty,
                PlayerRngCounter: 0, MonsterRngCounter: 0),
            RunRng("seed-42"), PlayerRng(42u),
            Tokens("StrikeSilent", "DefendSilent", "Neutralize",
                "Survivor", "Acrobatics", "Backflip"),
            Stamp()));
        ...
        result.Add(new StateCodecFixture(
            ...
            new CombatState(
                ...
                ExhaustPile: Pile(
                    Card(10, "StrikeSilent"), Card(11, "StrikeSilent"),
                    Card(12, "DefendSilent"), Card(13, "Neutralize"),
                    Card(14, "Survivor"), Card(15, "Acrobatics"),
                    Card(16, "Backflip")),
                PlayerRngCounter: 50, MonsterRngCounter: 15),
            RunRng("seed-42", shuffleCount: 5), PlayerRng(42u), Tokens(), Stamp()));
        ...
        result.Add(new StateCodecFixture(
            ...
            new CombatState(
                ...
                DiscardPile: Pile(Card(10, "StrikeSilent"), Card(12, "DefendSilent")),
                ExhaustPile: CardPile.Empty,
                PlayerRngCounter: 10, MonsterRngCounter: 4),
            RunRng("seed-42"), PlayerRng(42u), Tokens(), Stamp()));
        ...
        result.Add(new StateCodecFixture(
            ...
            new CombatState(
                ...
                DrawPile: CardPile.Empty,
                HandPile: Pile(Card(20, "StrikeSilent"), Card(21, "DefendSilent")),
                DiscardPile: Pile(Card(10, "StrikeSilent"), Card(11, "StrikeSilent"),
                    Card(12, "DefendSilent")),
                ExhaustPile: Pile(Card(13, "Survivor")),
                PlayerRngCounter: 80, MonsterRngCounter: 30),
            RunRng("seed-42", shuffleCount: 6), PlayerRng(42u, rewardsCount: 2),
            Tokens(), Stamp()));
        ...
        result.Add(new StateCodecFixture(
            ...
            new CombatState(
                ...
                Player: BuildPlayer(70, 70, 0),
                Enemies: ImmutableList.Create(
                    BuildEnemy(1, "CalcifiedCultist", 50, 50, 0,
        ...
        result.Add(new StateCodecFixture(
            ...
            new CombatState(
                TurnCounter: 0,
                Phase: CombatPhase.CombatStart,
                Player: new Creature(0, "", 0, 0, 0, ImmutableList<PowerInstance>.Empty, null, true),
                Enemies: ImmutableList<Creature>.Empty,
                Energy: 0, BaseEnergyPerTurn: 0, HandDrawSize: 0,
                DrawPile: CardPile.Empty, HandPile: CardPile.Empty,
                DiscardPile: CardPile.Empty, ExhaustPile: CardPile.Empty,
                PlayerRngCounter: 0, MonsterRngCounter: 0),
            RunRng("seed-42"), PlayerRng(42u), Tokens(), Stamp()));
        ...
        result.Add(new StateCodecFixture(
            ...
            new CombatState(
                ...
                Enemies: ImmutableList.Create(
                    BuildEnemy(1, "CalcifiedCultist", 30, 50, 0, Attack(6))),
                Energy: 1, BaseEnergyPerTurn: 3, HandDrawSize: 5,
                DrawPile: CardPile.Empty, HandPile: CardPile.Empty,
                DiscardPile: CardPile.Empty, ExhaustPile: CardPile.Empty,
                PlayerRngCounter: 25, MonsterRngCounter: 10),
            RunRng("seed-42"), PlayerRng(42u), Tokens(), Stamp()));
        ...
        result.Add(new StateCodecFixture(
            ...
            new CombatState(
                ...
                DrawPile: CardPile.Empty, HandPile: CardPile.Empty,
                DiscardPile: CardPile.Empty, ExhaustPile: CardPile.Empty,
                PlayerRngCounter: 1000, MonsterRngCounter: 999),
        ...
        result.Add(new StateCodecFixture(
            ...
            new CombatState(
                ...
                DiscardPile: CardPile.Empty, ExhaustPile: CardPile.Empty,
                PlayerRngCounter: 0, MonsterRngCounter: 0),
            RunRng("seed-42"), PlayerRng(42u), Tokens(),
            StampUnicode()));
        ...
        result.Add(new StateCodecFixture(
            ...
            new CombatState(
                ...
                DiscardPile: CardPile.Empty, ExhaustPile: CardPile.Empty,
                PlayerRngCounter: 0, MonsterRngCounter: 0),
            RunRng("seed-42"), PlayerRng(42u), Tokens("A", "B"),
            StampLongBuildId()));
        ...
        result.Add(new StateCodecFixture(
            ...
            new CombatState(
                TurnCounter: 0,
                Phase: CombatPhase.CombatStart,
                Player: new Creature(0, "Silent — δ Class", 70, 70, 0,
                    ImmutableList<PowerInstance>.Empty, null, true),
                Enemies: ImmutableList.Create(
