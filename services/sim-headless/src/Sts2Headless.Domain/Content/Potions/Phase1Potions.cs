...
public sealed class BlockPotion : PotionModel
{
    ...
    public BlockPotion() : base(CanonicalId, "Block Potion", PotionRarity.Common) { }
}
...
public sealed class FirePotion : PotionModel
{
    ...
    public FirePotion() : base(CanonicalId, "Fire Potion", PotionRarity.Common) { }
}
...
public sealed class EnergyPotion : PotionModel
{
    ...
    public EnergyPotion() : base(CanonicalId, "Energy Potion", PotionRarity.Common) { }
}
...
public sealed class ExplosiveAmpoule : PotionModel
{
    ...
    public ExplosiveAmpoule() : base(CanonicalId, "Explosive Ampoule", PotionRarity.Common) { }
}
...
public sealed class FlexPotion : PotionModel
{
    ...
    public FlexPotion() : base(CanonicalId, "Flex Potion", PotionRarity.Common) { }
}
...
public sealed class DexterityPotion : PotionModel
{
    ...
    public DexterityPotion() : base(CanonicalId, "Dexterity Potion", PotionRarity.Common) { }
}
...
public sealed class StrengthPotion : PotionModel
{
    ...
    public StrengthPotion() : base(CanonicalId, "Strength Potion", PotionRarity.Common) { }
}
...
public sealed class SkillPotion : PotionModel
{
    ...
    public SkillPotion() : base(CanonicalId, "Skill Potion", PotionRarity.Common) { }
}
...
public sealed class AttackPotion : PotionModel
{
    ...
    public const int CardChoices = 3;
    public AttackPotion() : base(CanonicalId, "Attack Potion", PotionRarity.Common) { }
}
...
public sealed class PowerPotion : PotionModel
{
    ...
    public const int CardChoices = 3;
    public PowerPotion() : base(CanonicalId, "Power Potion", PotionRarity.Common) { }
}
...
public sealed class SwiftPotion : PotionModel
{
    ...
    public SwiftPotion() : base(CanonicalId, "Swift Potion", PotionRarity.Common) { }
}
...
public sealed class BloodPotion : PotionModel
{
    ...
    public BloodPotion() : base(CanonicalId, "Blood Potion", PotionRarity.Common) { }
}
...
public sealed class PoisonPotion : PotionModel
{
    ...
    public PoisonPotion() : base(CanonicalId, "Poison Potion", PotionRarity.Common) { }
}
...
public sealed class FocusPotion : PotionModel
{
    ...
    public FocusPotion() : base(CanonicalId, "Focus Potion", PotionRarity.Common) { }
}
...
public sealed class CunningPotion : PotionModel
{
    ...
    public CunningPotion() : base(CanonicalId, "Cunning Potion", PotionRarity.Common) { }
}
...
public sealed class LiquidBronze : PotionModel
{
    ...
    public LiquidBronze() : base(CanonicalId, "Liquid Bronze", PotionRarity.Uncommon) { }
}

public sealed class GamblersBrew : PotionModel
{
    public const string CanonicalId = "GamblersBrew";
    public GamblersBrew() : base(CanonicalId, "Gambler's Brew", PotionRarity.Uncommon) { }
}
...
public sealed class HeartOfIron : PotionModel
{
    ...
    public HeartOfIron() : base(CanonicalId, "Heart of Iron", PotionRarity.Uncommon) { }
}
...
public sealed class FairyInABottle : PotionModel
{
    ...
    public FairyInABottle() : base(CanonicalId, "Fairy in a Bottle", PotionRarity.Rare) { }
}
...
public sealed class LiquidMemories : PotionModel
{
    ...
    public LiquidMemories() : base(CanonicalId, "Liquid Memories", PotionRarity.Rare) { }
}

public sealed class EntropicBrew : PotionModel
{
    public const string CanonicalId = "EntropicBrew";
    public EntropicBrew() : base(CanonicalId, "Entropic Brew", PotionRarity.Rare) { }
}
