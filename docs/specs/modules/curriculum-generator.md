...
- **Adversarial scenario generation (Phase 5).** Use the value head's own uncertainty to find weak spots; synthesize combat states the agent fails on; feed into Q3 with adversarial provenance tag.
