"""Shared length-delimited varint + frame codec for the experience-store.
...
imports. Sampler-specific helpers (e.g. `is_degenerate_combat_sample`,
`frame_trailer`, `frame_steps`) remain in the sampler module.
"""
